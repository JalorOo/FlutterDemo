...
class RenderCustomCheckbox extends RenderBox with RenderObjectAnimationMixin {
  ...
  void _drawBackground(PaintingContext context, Rect rect) {
    ...
    var rects = [
      // a new rectangle with edges moved outwards by the given delta.
      // 就是一个框
    ...
    var rectProgress = Rect.lerp(
      rects[0],
      rects[1],
      // 在 [progress] 与 [bgAnimationInterval] 选择一个最小的做百分比
      // 超过 [bgAnimationInterval] 就是一个 空内心 的背景
