...
class _GradientCircularProgressPainter extends CustomPainter {
  _GradientCircularProgressPainter({
    ...
    this.backgroundColor = const Color(0xFFEEEEEE),
    required this.radius,
    this.total = 2 * pi, //采用弧度制 2pi = 360度
    required this.colors,
    this.stops,
    required this.value
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _value = _value.clamp(.0, 1.0) * total; //限制范围
    double _start = .0; //开始角度
    ...
    var paint = Paint()
      ..strokeCap = strokeCapRound ? StrokeCap.round : StrokeCap.butt  //绘制是否采用圆角
      ..style = PaintingStyle.stroke //填充与否，现在是描边
    ...
    if (backgroundColor != Colors.transparent) {
      ...
      // 绘制关键: 给定矩形，起始角度，扫过的角度，是否链接重点，画笔
      canvas.drawArc(
          rect,
          0,
          total,
